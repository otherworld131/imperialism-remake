  ...
  return (
    <div style={{ position: 'relative', width: '100%', height: '100%' }}>
      <canvas
        ...
        role="img"
        aria-label="Game map"
        style={{ width: '100%', height: '100%', display: 'block', cursor: dragging ? 'grabbing' : isDiplomacyTargetMode ? (isDiplomacyTargetInvalid ? 'not-allowed' : 'crosshair') : 'grab', touchAction: 'none' }}
