...
mod tests {
    ...
    fn ai_builds_regulars_when_army_small_and_can_afford() {
        ...
        ai.add_goods(GoodsType::Arms, 5);
        // Need enough workforce to pass the chain-labor gate
        // (`ai_manage_economy` bootstraps 6 chain buildings = 18 labor needed
        // at 0.66 ratio = 12). 20 untrained = 20 labor clears it.
    ...
    fn ai_builds_unit_when_army_small_for_territory() {
        ...
        // Pass chain-labor gate (6 buildings × cap 2 × 2 labor = 18 required,
        // × 0.66 ratio ≈ 12).
        ai.economy.labor.untrained = 20;
