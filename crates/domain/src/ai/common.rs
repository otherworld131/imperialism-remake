...
pub struct PersonalityConfig {
    ...
    // War declaration
    pub war_cooldown: u32,
    pub army_min_for_war: usize,
    pub war_threshold: f64,
    pub opportunism_weight: f64,
    pub opp_start: f64,
    pub opp_end: f64,
    pub opp_decay_turns: u32,
    pub res_per_missing: f64,
    pub res_cap: f64,
    // Combat thresholds
    pub min_artillery_for_minor_war: usize,
    pub capital_save_for_last_penalty: i32,
    // War worthiness
    pub won_enough_captures: usize,
    pub lost_enough_losses: usize,
    pub lost_enough_likelihood: f64,
    pub won_enough_marginal: f64,
    // Peace negotiation
    pub peace_accept_threshold: f64,
    pub peace_reject_threshold: f64,
    pub peace_stalemate_duration: u32,
    // Treaty acceptance bias
    pub nap_accept_bias: f64,
    pub alliance_accept_bias: f64,
    // Diplomacy spending
    pub grant_amount_dollars: u32,
    pub grant_interval_turns: u32,
    pub election_grant_dollars: u32,
    pub embassy_treasury_threshold_dollars: u32,
    // Economy/infrastructure
    pub infra_base_budget_dollars: u32,
    pub expansion_threshold_multiplier: u32,
    // Naval
    pub max_merchant_ships: usize,
    // Tactical
    pub fort_capital: bool,
}
    ...
    pub fn for_personality(personality: AiPersonality) -> Self {
        match personality {
            AiPersonality::Aggressive => Self {
                ...
                army_min_for_war: 3,
                war_threshold: 0.3,
                opportunism_weight: 1.2,
                opp_start: 0.25,
                opp_end: 0.05,
                opp_decay_turns: 15,
                res_per_missing: 0.12,
                res_cap: 0.25,
                min_artillery_for_minor_war: 2,
                capital_save_for_last_penalty: 10,
                ...
                nap_accept_bias: -0.2,
                alliance_accept_bias: -0.15,
                grant_amount_dollars: 0,
                grant_interval_turns: 0,
                election_grant_dollars: 500,
                embassy_treasury_threshold_dollars: 15_000,
                infra_base_budget_dollars: 1500,
            ...
            AiPersonality::Diplomatic => Self {
                ...
                army_min_for_war: 8,
                war_threshold: 0.9,
                opportunism_weight: 0.6,
                opp_start: 0.50,
                opp_end: 0.20,
                opp_decay_turns: 30,
                res_per_missing: 0.06,
                res_cap: 0.15,
                min_artillery_for_minor_war: 3,
                capital_save_for_last_penalty: 25,
                ...
                nap_accept_bias: 0.3,
                alliance_accept_bias: 0.4,
                grant_amount_dollars: 500,
                grant_interval_turns: 4,
                election_grant_dollars: 1000,
                embassy_treasury_threshold_dollars: 5_000,
                infra_base_budget_dollars: 2500,
                expansion_threshold_multiplier: 2,
                max_merchant_ships: 1,
                fort_capital: true,
            },
            AiPersonality::Economic => Self {
                ...
                army_min_for_war: 5,
                war_threshold: 0.6,
                opportunism_weight: 0.8,
                opp_start: 0.40,
                opp_end: 0.15,
                opp_decay_turns: 25,
                res_per_missing: 0.08,
                res_cap: 0.15,
                min_artillery_for_minor_war: 3,
                capital_save_for_last_penalty: 25,
                ...
                nap_accept_bias: 0.1,
                alliance_accept_bias: 0.0,
                grant_amount_dollars: 500,
                grant_interval_turns: 6,
                election_grant_dollars: 500,
                embassy_treasury_threshold_dollars: 10_000,
                infra_base_budget_dollars: 3000,
            ...
            AiPersonality::Balanced => Self {
                ...
                army_min_for_war: 4,
                war_threshold: 0.5,
                opportunism_weight: 1.0,
                opp_start: 0.35,
                opp_end: 0.10,
                opp_decay_turns: 20,
                res_per_missing: 0.10,
                res_cap: 0.20,
                min_artillery_for_minor_war: 2,
                capital_save_for_last_penalty: 25,
                won_enough_captures: 2,
                ...
                peace_stalemate_duration: 15,
                nap_accept_bias: 0.1,
                alliance_accept_bias: 0.1,
                grant_amount_dollars: 500,
                grant_interval_turns: 8,
                election_grant_dollars: 500,
                embassy_treasury_threshold_dollars: 10_000,
                infra_base_budget_dollars: 2000,
                expansion_threshold_multiplier: 2,
                max_merchant_ships: 1,
                fort_capital: false,
            },
