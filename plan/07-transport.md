...
### Freight Cars
- [x] Built in the Railyard: 2 labor + 1 lumber + 1 steel per car
- [x] No maintenance cost once built — permanent assets
- [x] Each car carries one unit of one resource type per turn
- [ ] Cars assigned to routes via the Transport screen
- [ ] Assignment uses slider UI (proportion of capacity per resource)
- [x] Unit tests: freight car construction cost validation
- [x] Unit tests: capacity correctly increases with each car built
